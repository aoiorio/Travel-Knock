                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return _blockUsersList.contains(
                                _requestedKnock[index]['owner_id'])
                            ? const SizedBox()
                            : GestureDetector(
                                onTap: () {
